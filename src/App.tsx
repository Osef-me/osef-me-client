...
import { BeatmapDetailPage, BeatmapsetRedirectPage, CurrentPage, Help, ListPage, PackMakerPage, SettingsPage } from '@/components/pages'
    ...
    <ThemeProvider>
      ...
      <main className="w-full mx-auto px-2 sm:px-4 lg:px-8 mt-6">
        <Routes>
          ...
          <Route path="/packmaker" element={<PackMakerPage />} />
